...
function mostrarPagina(paginaId) {
    console.log("mostrarPagina chamado com ID:", paginaId); // Log para verificar se a função é chamada com o ID correto
    // Esconde todas as divs que começam com "p"
    var divs = document.querySelectorAll('div[id^="p"]');
    divs.forEach(function(div) {
        div.style.display = 'none';
    });

    // Mostra a div especificada
    var pagina = document.getElementById(paginaId);
    if (pagina) {
        pagina.style.display = 'block';
    } else {
        console.log("Elemento com ID " + paginaId + " não encontrado."); // Log se a div não for encontrada
    }
}
